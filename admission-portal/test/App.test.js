module.exports = {
  ...
  "Testing Signin Page for Applicant": function (browser) {
    ...
    "Testing Login Page for Applicant": function (browser) {
      ...
      .click("#loginButton") 
      .assert.urlEquals('http://localhost:8002/apply')
    },
    ...
    "Testing Status page of applicants": function (browser) {
      ...
      .assert.urlEquals('http://localhost:8002/status')
      const courseDetails=[
      ...
      .assert.urlEquals('http://localhost:8002/')
    },
    ...
    "Testing Login Page for Admin": function (browser) {
      ...
      .click("#loginButton") 
      .assert.urlEquals('http://localhost:8002/applications')
    },
    ...
    "Testing AddSeats page of admin": function (browser) {
      browser.click("nav > ul > li:nth-of-type(2) > a")
      .assert.urlEquals('http://localhost:8002/addseats')
